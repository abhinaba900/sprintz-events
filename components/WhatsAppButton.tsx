...
export const WhatsAppButton = () => {
  ...
  useEffect(() => {
    // Show tooltip after 2.5 seconds to attract attention, then hide after 8.5 seconds
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[99] flex items-center gap-3">
      ...
      <motion.a
        ...
        className="relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-tr from-[#128C7E] to-[#25D366] text-white shadow-[0_8px_30px_rgba(37,211,102,0.4)] hover:shadow-[0_8px_30px_rgba(37,211,102,0.7)] transition-shadow duration-300 focus:outline-none focus:ring-4 focus:ring-emerald-400"
        aria-label="Chat on WhatsApp"
      >
        {/* Pulsating background ripples */}
        <span className="absolute inset-0 rounded-full bg-emerald-500/30 animate-ping-slow -z-10" />
        <span className="absolute inset-0 rounded-full bg-emerald-400/20 animate-ping-slower -z-10" />
