        ...
        <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-primary pt-24 md:pt-32">
          ...
          <div className="container mx-auto px-6 relative z-10 text-white">
            <div className="max-w-4xl">
              ...
              >
                Built for <br />
                <span className="text-accent underline decoration-8 underline-offset-10">
                  Seamless Events
                </span>{" "}
                <br />& Powerful Experiences
              </motion.h1>
              ...
              >
                At Sprintz Events, we specialize in creating high-quality
                corporate and sports experiences that are structured, engaging,
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <span className="text-accent font-black tracking-[0.3em] uppercase text-xs block mb-4 italic">
                  Our Story
                </span>
                <h2 className="text-4xl md:text-5xl font-black text-primary italic uppercase tracking-tighter mb-8 leading-none">
                  Who We Are
                </h2>
                <div className="w-20 h-2 bg-accent mb-8" />
                <p className="text-xl text-zinc-600 leading-relaxed font-medium mb-8">
                  Sprintz Events is an end-to-end event management company
                  focused on delivering seamless corporate and sports events.
                </p>
                <p className="text-xl text-zinc-900 leading-relaxed font-bold italic border-l-4 border-accent pl-8 py-2 bg-accent/5 rounded-r-2xl">
                  From planning to execution, we handle every detail so our
                  clients can focus on the experience.
                </p>
              </motion.div>
              <motion.div
        ...
        <section className="py-24 bg-subtle-grey">
          <div className="container mx-auto px-6">
            <div className="text-center mb-20">
              ...
              <h2 className="text-5xl font-black text-primary italic tracking-tight uppercase leading-none">
                Our Approach
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  icon: Layout,
                  desc: "Nothing is left to chance. We map every single logistical detail.",
                },
                {
                  title: "Professional Execution",
                  icon: Award,
                  desc: "On-ground management that is sharp, punctual, and reliable.",
                },
                {
                  title: "Attention to Detail",
                  icon: Search,
                  desc: "From branding to ball-by-ball management, we see the small things.",
                },
                {
                  title: "Client-First Approach",
                  icon: Heart,
                  desc: "Your goals are our benchmarks. We execute until you're satisfied.",
                },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
                ...
                >
                  ...
                  <h4 className="text-xl font-black text-primary italic uppercase tracking-tighter mb-4">
                    {item.title}
                  </h4>
            ...
            <div className="flex flex-col md:flex-row gap-20 items-center">
              <div className="md:w-1/2">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-primary italic uppercase tracking-tighter leading-[0.85] mb-12">
                  Our <br />
                  <span className="text-accent underline decoration-8 decoration-accent/30">
                    Experience
                  </span>
                </h2>
                <div className="space-y-6 text-xl text-zinc-600 font-medium leading-relaxed italic">
                  <p>
                    With hands-on experience in organizing corporate sports
                    tournaments, team-building activities, and large-scale
                    events, Sprintz Events brings both operational expertise and
                    on-ground execution capability.
                  </p>
                  <p className="text-zinc-900 font-black tracking-tight">
                    We understand the challenges of managing participants,
                    logistics, and timelines — and ensure everything runs
              ...
              <div className="md:w-1/2 relative">
                <div className="p-8 md:p-16 rounded-[4rem] bg-primary text-white shadow-2xl relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <h4 className="text-3xl font-black italic uppercase tracking-tighter mb-6">
                      Built for Scaling
                    </h4>
                    <p className="text-white/60 font-medium leading-relaxed mb-8">
                      Whether you have 50 employees or 5,000 participants, our
                      systems are built to scale without losing the personal
                      touch.
                    </p>
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col lg:flex-row gap-20 items-center max-w-6xl mx-auto">
              <div className="lg:w-1/2">
                ...
                <h2 className="text-5xl font-black text-primary italic uppercase tracking-tighter mb-12">
                  Core Operations
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    ...
                    <div
                      key={id}
                      className="flex items-center gap-4 p-6 rounded-3xl bg-subtle-grey border border-zinc-50 hover:border-accent/40 transition-all cursor-default"
                    >
                      <div className="w-10 h-10 bg-white rounded-xl shadow-sm flex items-center justify-center text-accent">
                        <item.icon size={20} />
                      </div>
                      <span className="font-bold text-primary italic uppercase tracking-tighter text-sm">
                        {item.title}
                      </span>
                    </div>
                  ))}
              ...
              <div className="lg:w-1/2 relative bg-subtle-grey p-16 rounded-[4rem]">
                <h3 className="text-3xl font-black text-primary italic uppercase tracking-tighter mb-8 leading-tight">
                  Why Sprintz Events?
                </h3>
                <p className="text-lg text-zinc-500 font-medium leading-relaxed italic mb-8 border-l-4 border-primary pl-8">
                  What sets us apart is our ability to combine structured
                  planning with seamless execution.
                </p>
                <p className="text-lg text-zinc-700 font-bold italic">
                  We don’t just organize events — we create well-managed
                  experiences that reflect professionalism and precision. We
                  take ownership of every single attendee's experience.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
              {[
                ...
                },
                {
                  ...
                  image: "/santosh.webp",
                  desc: "Bringing extensive experience in corporate leadership and business management, Santosh focuses on strategic planning, partnerships, and overall business coordination for Sprintz Events.",
                },
                {
                  name: "👩 Mamatha Santhosh",
                  role: "Client Relations & Event Coordination",
                  image: "/Mamatha.webp",
...

                {
                  ...
                  image: "/team.webp",
                  desc: "An active sports enthusiast responsible for on-ground coordination, logistics support, player management, and smooth event execution.",
                },
              ].map((member, idx) => (
                <motion.div
                  key={idx}
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ delay: idx * 0.1 }}
                  className="p-8 rounded-[3.5rem] bg-subtle-grey border border-zinc-50 hover:bg-white hover:shadow-2xl transition-all duration-500 group relative overflow-hidden"
                >
                  <div className="flex flex-col sm:flex-row gap-8 items-center sm:items-start">
                    <div className="w-32 h-32 rounded-[2rem] overflow-hidden relative shrink-0 shadow-lg border-2 border-white">
                      <Image
                        src={member.image}
                        alt={member.name}
                        fill
                    ...
                    <div className="flex-1 text-center sm:text-left">
                      <h4 className="text-2xl font-black text-primary italic uppercase tracking-tighter mb-1">
                        {member.name}
                      </h4>
                      <span className="text-accent font-black italic uppercase tracking-widest text-[10px] block mb-4">
                        {member.role}
                      </span>
                      <p className="text-sm text-zinc-500 font-medium leading-relaxed">
                        {member.desc}
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <div className="relative z-10 max-w-4xl mx-auto">
                <h2 className="text-4xl md:text-5xl font-black mb-10 italic uppercase tracking-tighter leading-[0.9]">
                  Let's Work Together
                </h2>
                <p className="text-xl md:text-2xl text-white/80 mb-12 font-medium max-w-2xl mx-auto italic">
                  Looking to plan your next event? We’re here to help you turn
                  vision into flawless execution.
                </p>
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  <Button
                    size="lg"
                    className="bg-white text-accent hover:bg-zinc-100 h-20 px-16 rounded-3xl text-3xl font-black italic shadow-2xl uppercase"
                    onClick={openModal}
                  >
                    Contact Us
                  </Button>
                  <Button
                    size="lg"
                    className="bg-primary hover:bg-primary/95 h-20 px-16 rounded-3xl text-3xl font-black italic shadow-2xl uppercase"
                    onClick={openModal}
                  >
                    Plan Your Event
                  </Button>
