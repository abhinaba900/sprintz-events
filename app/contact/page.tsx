              ...
              >
                ...
                <div className="space-y-6">
                   ...
                   <div className="space-y-4">
                      <a href="tel:+919743715519" className="flex items-center gap-6 p-6 rounded-[2.5rem] bg-subtle-grey border border-zinc-100 group hover:border-accent/40 transition-all">
                        ...
                        <div>
                           ...
                           <div className="text-lg font-black text-primary italic uppercase tracking-tighter">+91 97437 15519</div>
                        </div>
                      </a>
                      ...
                      <a href="https://wa.me/919743715519?text=Hi%20Sprintz%20Events%2C%20I'd%20like%20to%20plan%20an%20event!" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 p-8 rounded-[3rem] bg-primary text-white group hover:bg-accent transition-all shadow-xl">
